...
public ResponseEntity<Object> validation(ConstraintViolationException e, WebRequest request) {
	...
	return handleExceptionInternalConstraint(
		e, ErrorCode.valueOf(errorMessage), HttpHeaders.EMPTY, request);
}
...
public ResponseEntity<Object> exception(Exception e, WebRequest request) {
	...
	return handleExceptionInternalFalse(
		...
		HttpHeaders.EMPTY,
		ErrorCode._INTERNAL_SERVER_ERROR.getHttpStatus(),
		request,
		e.getMessage());
}
...
private ResponseEntity<Object> handleExceptionInternal(
	Exception e, ErrorCode errorCode, HttpHeaders headers, HttpServletRequest request) {
	...
	return super.handleExceptionInternal(e, body, headers, errorCode.getHttpStatus(), webRequest);
}
